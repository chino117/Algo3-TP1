...
void Solve_Backtracking_Opt(const ConjLineal& s, const DatosProblema& dp, unsigned int b_candidato, unsigned int t_candidato, unsigned int& sol, unsigned int idx_elem, unsigned int& nodos){
    nodos++;
...
ResultadoProblema Backtracking_Opt(const ConjLineal& s, const DatosProblema& dp){
    ...
    Solve_Backtracking_Opt(orig, dp, 0, 0, res.b, 0, res.nodos);
