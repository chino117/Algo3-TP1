...
def correr_exp_especial_back():
    ...
    correr_metodos(3, 4, os.path.join(paths["casos_especiales"], "backtracking"), "datos_especial_backtracking.csv")
    print("Fin experimentos")

def correr_exp_especial_dinamica():
    print("Corriendo experimentos de input especial de dinamica")
    correr_metodos(4, 5, os.path.join(paths["casos_especiales"], "dinamica"), "datos_especial_dinamica.csv")
    print("Fin experimentos")
